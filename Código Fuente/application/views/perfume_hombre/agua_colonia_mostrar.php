<h1>Hombre</h1>
	<em></em>
	<h2><a href="<?= base_url('home/mostrar')?>">Inicio</a><label>/</label>Hombre<label>/</label>Agua de Colonia</h2>
</div>
</div>
<div class="product">
	<div class="container">
...
<?php foreach ($agua_colonias as $colonia): ?>
	<div class="col-md-4 item-grid1 simpleCart_shelfItem">
		<div class=" mid-pop">
			<div class="pro-img">
				<img src="<?= base_url('product_images/'.$colonia['id'].'.png')?>" class="img-responsive" alt="">
				<div class="zoom-icon ">
					<!-- IMAGEN DEL PRODUCTO -->
					<a class="picture" href="<?= base_url('product_images/'.$colonia['id'].'.png')?>" rel="title" class="b-link-stripe b-animate-go  thickbox"><i class="glyphicon glyphicon-search icon "></i></a>
					<a href="<?= base_url('perfume/perfume_producto/'.$colonia['id']); ?>"><i class="glyphicon glyphicon-menu-right icon"></i></a>
				</div>
			</div>
			<div class="mid-1">
				<div class="women">
					<div class="women-top">
						<span><?= $colonia['marca_nombre'];?></span>
						<h6><a href="#"><?= $colonia['nombre']; ?></a></h6>
					</div>
					<!-- IMAGEN DEL CARRITO -->
					<div class="img item_add">
						<?php if ($this->session->userdata('logged_in')){?>
							<a href="<?= base_url('pedido/comprar/'.$colonia['id']); ?>"><img src="<?= base_url('assets/images/ca.png')?>" alt="" width="40" height="40"></a>
						<?php 	}else{ ?>
			...
			<div class="mid-2">
				...
				<p ><em class="item_price">$<?= $colonia['precio'];?></em></p>
          </td>
				<div class="block">
